...
@interface SWGConnectorApi ()
    @property (readwrite, nonatomic, strong) NSMutableDictionary *defaultHeaders;
@end

@implementation SWGConnectorApi

static SWGConnectorApi* singletonAPI = nil;
...
+(SWGConnectorApi*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {
    ...
    if (singletonAPI == nil) {
        singletonAPI = [[SWGConnectorApi alloc] init];
...
-(NSNumber*) connectorsGetWithCompletionBlock: (NSString*) name
    ...
    if(getItUrl != nil) {
        ...
        queryParams[@"get_it_url"] = getItUrl;
    }
    if(shortDescription != nil) {
        
        queryParams[@"short_description"] = shortDescription;
    }
    if(longDescription != nil) {
        
        queryParams[@"long_description"] = longDescription;
    }
    if(enabled != nil) {
    ...
    return [self.apiClient requestWithCompletionBlock: resourcePath
                  ...
                  completionBlock((SWGInlineResponse2005*)data, error);
              }
          ];
}
...
-(NSNumber*) connectorsPostWithCompletionBlock: (SWGConnector*) body
    ...
    return [self.apiClient requestWithCompletionBlock: resourcePath
                  ...
                  completionBlock((SWGInlineResponse2006*)data, error);
              }
          ];
}
...
-(NSNumber*) connectorsIdGetWithCompletionBlock: (NSNumber*) _id
    ...
    if (_id == nil) {
        [NSException raise:@"Invalid parameter" format:@"Missing the required parameter `_id` when calling `connectorsIdGet`"];
    }
...
-(NSNumber*) connectorsIdPutWithCompletionBlock: (NSNumber*) _id
    ...
    // verify the required parameter '_id' is set
    if (_id == nil) {
        [NSException raise:@"Invalid parameter" format:@"Missing the required parameter `_id` when calling `connectorsIdPut`"];
    }
...
-(NSNumber*) connectorsIdDeleteWithCompletionBlock: (NSNumber*) _id
    ...
    // verify the required parameter '_id' is set
    if (_id == nil) {
        [NSException raise:@"Invalid parameter" format:@"Missing the required parameter `_id` when calling `connectorsIdDelete`"];
    }
