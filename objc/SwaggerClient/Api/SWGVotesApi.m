...
NSString* kSWGVotesApiErrorDomain = @"SWGVotesApiErrorDomain";
NSInteger kSWGVotesApiMissingParamErrorCode = 234513;
...
-(NSNumber*) v1VotesDeletePostWithBody: (SWGVoteDelete*) body
    ...
    if (body == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGVotesApiErrorDomain code:kSWGVotesApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
