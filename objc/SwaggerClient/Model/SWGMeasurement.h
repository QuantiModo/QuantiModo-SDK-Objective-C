...
/* Seconds between the start of the event measured and 1970 (Unix timestamp) [optional]
 */
@property(nonatomic) NSNumber* startTimeEpoch;

@property(nonatomic) SWGHumanTime* humanTime;
/* Converted measurement value in requested unit 
 */
@property(nonatomic) NSNumber* value;
/* Original value as originally submitted [optional]
 */
@property(nonatomic) NSNumber* originalValue;
/* Original Unit of measurement as originally submitted [optional]
 */
@property(nonatomic) NSString* originalunitAbbreviatedName;
