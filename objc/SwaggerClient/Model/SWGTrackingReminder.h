...
/* Earliest time of day at which reminders should appear in UTC HH:MM:SS format [optional]
 */
@property(nonatomic) NSString* reminderStartTime;
/* Latest time of day at which reminders should appear in UTC HH:MM:SS format [optional]
 */
...
/* UTC ISO 8601 \"YYYY-MM-DDThh:mm:ss\"  timestamp for the reminder time of the latest tracking reminder notification that has been pre-emptively generated in the database [optional]
 */
@property(nonatomic) NSDate* latestTrackingReminderNotificationReminderTime;
/* UTC ISO 8601 \"YYYY-MM-DDThh:mm:ss\"  timestamp for the last time a measurement was received for this user and variable [optional]
 */
 ...
 */
@property(nonatomic) NSString* startTrackingDate;
/* Latest date on which the user should be reminded to track in YYYY-MM-DD format [optional]
 */
@property(nonatomic) NSString* stopTrackingDate;
